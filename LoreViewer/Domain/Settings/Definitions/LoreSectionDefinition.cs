...
namespace LoreViewer.Domain.Settings.Definitions
{
  ...
  public class LoreSectionDefinition : LoreDefinitionBase, ISectionDefinitionContainer, IFieldDefinitionContainer, IRequirable, IDeepCopyable<LoreSectionDefinition>
  {
    ...
    public void MergeFrom(LoreSectionDefinition parentSection)
    {
      ...
      freeform |= parentSection.freeform;
    }
    ...
    public override bool IsModifiedFromBase
    {
      get
      {
        ...
        if (freeform != (Base as LoreSectionDefinition).freeform)
          return true;

        if (required != (Base as LoreSectionDefinition).required)
          return true;
    ...
    {
      LoreSectionDefinition typeDef = MemberwiseClone() as LoreSectionDefinition;
